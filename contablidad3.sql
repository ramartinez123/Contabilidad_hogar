...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-12-2023 a las 19:05:17
...
(1131, 1, 0, 2, '2023-09-10', 10000, 1, 1, '', 0),
(1219, 2, 0, 1, '2023-10-02', 300000, 1, 1, '', 0),
(1220, 424, 0, 2, '2023-10-02', 300000, 1, 1, '', 0),
(1221, 341, 0, 1, '2023-10-02', 8000, 1, 1, '', 0),
(1222, 213, 0, 2, '2023-10-02', 8000, 1, 1, '', 0),
(1223, 5, 0, 1, '2023-10-02', 300, 1, 1, '', 0),
(1224, 426, 0, 2, '2023-10-02', 300, 1, 1, '', 0),
(1225, 304, 0, 1, '2023-10-01', 3000, 1, 1, '', 0),
(1226, 210, 0, 2, '2023-10-01', 3000, 1, 1, '', 0);
...
(1, 'Juan', 'pbkdf2:sha256:260000$t6OXUXAq2hMagTXK$af640cdee0dc6a151f9bd0730974352324b50e736500439f6db0b97c3907e556');
...
--
ALTER TABLE `accountingtransactions`
  MODIFY `idAccountingTransaction` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1227;
...
--
ALTER TABLE `exchange`
  MODIFY `idExchange` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
